<div class="px-2 md:px-3 py-4">
    <button type="button" class="group transition ease-in-out duration-150 flex items-center justify-center focus:outline-none" x-on:click="modal = true">
    ...
    <div x-show="modal"
         class="px-4 pb-4 md:pb-0 md:px-0 fixed top-0 inset-0 z-30 w-screen h-screen bg-gradient-overlay">
        <div class="h-full w-full flex items-end md:items-center justify-center">
            <div class="w-full md:w-3/5 lg:w-5/12 bg-gray-50 p-10 rounded-md shadow-md relative font-bodyFont" x-on:click.away="modal = false">
                <div class="">
                    ...
                    <div class="">
                        <div>
                            <input aria-label="Email address"
                                   ...
                                   value="{{ old('email') }}"
                                   required
                                   class="appearance-none rounded-md relative block w-full px-3 py-3 border border-gray-300 @error('email'){{'border-red-500'}}@enderror placeholder-gray-500 text-gray-900  focus:outline-none focus:shadow-outline-blue focus:border-green-500 focus:z-10 text-sm sm:leading-5"
                        ...
                        <div class="mt-4">
                            <input aria-label="Password"
                                   ...
                                   type="password"
                                   required
                                   class="appearance-none rounded-md relative block w-full px-3 py-3 border border-gray-300 @error('password'){{'border-red-500'}}@enderror placeholder-gray-500 text-gray-900 focus:outline-none focus:shadow-outline-blue focus:border-green-500 focus:z-10 text-sm sm:leading-5 relative"
                ...
                <div class="absolute right-0 top-0 text-black p-2 flex items-center justify-center cursor-pointer"
                     x-on:click="modal = false">
                    <svg class="w-4 h-4 text-red-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                         fill="currentColor">
                        <path fill-rule="evenodd"
