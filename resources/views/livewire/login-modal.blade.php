<div class="px-2 md:px-3 py-4">
    ...
    <div x-show="modal"
         class="fixed top-0 inset-0 z-30 bg-gray-50 w-screen h-screen bg-gradient-overlay flex items-center justify-center">
        <div class="w-2/5 bg-gray-50 p-10 rounded-md shadow-md relative font-bodyFont" x-on:click.away="modal = false">
            <div class="">
