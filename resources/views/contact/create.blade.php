...
<header class="bg-gray-800">
    <div class="container mx-auto relative pt-6 px-4 sm:px-6 lg:px-8">
...
<main>
    <section class="pt-5 sm:pt-7 md:pt-14 pb-5 md:pb-32 flex items-center justify-center bg-gray-800">
        <div class="flex flex-col items-center justify-center">
            <span
                class="uppercase text-sm sm:text-lg md:text-xl font-normal tracking-widest font-titleFont mb-2 text-secondary-200">Contact Us</span>
    ...
    <section class="container mx-auto md:-mt-24 z-10 pt-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-white relative shadow-2xl sm:rounded-sm ">
            <div class="h-96">
                <iframe width="100%"
                        height="100%"
                        class="rounded-t-sm"
            ...
            <div class="flex flex-col md:flex-row flex-col-reverse divide-x divide-secondary-200 relative">
                <div class="absolute top-0 w-full h-1 md:h-0.5 bg-indigo-700"></div>
                        ...
                        <div class="grid grid-cols-2 font-bodyFont w-full lg:w-4/5">
                            <div
                                ...
                                <div class="flex flex-col justify-start items-center space-y-2 mb-4">
                                    <svg class="w-7 h-7 mt-3 text-indigo-700" xmlns="http://www.w3.org/2000/svg"
                                         fill="none"
                                    ...
                                    <p class="font-light text-xs text-secondary-500 text-center">
                                        One Stop Solutions,<br> Martam Ghaiyabari, Bermiok-Geyzing,<br> West Sikkim
                                        737113.
                                    </p>
                                </div>
                            </div>
    ...
    @if(session('success'))
        <section class="fixed bottom-0 w-screen bg-indigo-700 px-4 font-title z-50 font-bodyFont"
                 x-data="{ open: true }"
                 x-show="open"
            ...
            <div class="flex flex-col md:flex-row">
                <div class="flex-1 flex-col mb-10 md:mb-2">
                    ...
                    <div class="text-xs text-gray-500 mb-2">
                        Sikkim's e-commerce store. Multi-vendor, Multi-tenant, No commissions and no hidden
                        charges.
            ...
            <div class="flex flex-col md:flex-row">
                <div class="flex flex-col md:ml-8 lg:ml-16 mb-10 md:mb-0">
                    ...
                    <div class="text-xs font-medium tracking-wide text-gray-400 flex space-y-2 mb-4 flex-col">
                        ...
                        <a href="" class="hover:text-indigo-600 transition ease-in-out duration-150">Supply
                            Chain</a>
                        @auth()
